...
heroImage: '/images/power-pylon.jpg'
...
<div
  style={{
    ...
    margin: '1em',
    position: 'relative',
    paddingBottom: '55.65693430656934%',
    height: 0,
  }}
>
  <iframe
...
I guess having the pinned version info in the package.json is not to everyone's taste. I guess they could probably add a `.voltarc` in the future 🤷‍♂️. Personally, it doesn't bother me.
