...
![make a zap](/images/blog/make-a-zap.jpg)
...
![select trigger app](/images/blog/select-trigger-app.jpg)

Then you can choose what event should start the Zap. We want to use `New Activity`.

![select trigger event](/images/blog/select-trigger-event.jpg)

You will be asked to log into your Strava account. Mine was already linked!

![link strava account](/images/blog/link-strava-account.jpg)
...
![test trigger payload](/images/blog/test-trigger-payload.jpg)
...
![select action app](/images/blog/select-action-app.jpg)
...
![select action event](/images/blog/select-action-event.jpg)

As before, you will be asked to log into your Slack account. Mine was already linked (again)!

![link slack account](/images/blog/link-slack-account.jpg)
...
![advanced config](/images/blog/advanced-config.jpg)
...
![link username](/images/blog/link-username.jpg)

## Release it

Woops, don't forget to activate it 🙈.
![turn it on](/images/blog/turn-it-on.jpg)
...
![see the result](/images/blog/see-the-result.jpg)
