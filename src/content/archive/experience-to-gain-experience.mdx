---
title: 'When you need experience to gain experience'
date: '2020-10-02T22:42:40.969Z'
excerpt: 'Acquiring new skills takes time. Quite a lot in some cases. How do you validate your skills in the tech industry? Do you really have to work with a tech stack for years to be hirable?'
heroImage: '/images/bowl-of-eggs.jpg'
tags:
  [
    'Career',
    'Skills Development',
...
This is actually a variance of an interview question I was asked when I joined [Fizzer](https://www.fizzer.com). The question was something like "How do you master a technological stack". Back then, I replied that you need to have worked with it for a while. This way you get enough experience to _master_ it. Seeing a wide array of problems and finding how to solve them is what gives you a better understanding of your stack.
...
Couple hours before writing this I read this [article](https://kentcdodds.com/blog/how-to-get-experience-as-a-software-engineer) by [Kent C. Dodds](https://twitter.com/kentcdodds). It brings interesting ideas about how to progress and become more experimented as a software engineer.
...
That's interesting. No doubt, smooth seas never made a skilled sailor! But it can be hard to face real problems when you don't work on larger projects. I know I can't work on _fake_ side-projects for too long before losing interest.

One solution for that can be to work on smaller things like the little library I talked about in my last [post](https://maferland.com/blog/publishing-library-minimal-config). Bite-sized projects make it much easier to complete and feel like you achieved something. You can still gain very valuable knowledge by working on those. Plus they help build a little portfolio!
...
As I wrote this sentence, I thought of Shawn Wang's [Learn in public article](https://www.swyx.io/learn-in-public/). Go read it. Generating output, making stuff, having something to show. It makes you accountable, even if no one cares.
...
I feel blessed that I'm very motivated right now and that I have the time to invest myself in this kind of hobby. But we might want to reflect on this as an industry. We are **extremely** well rewarded for our knowledge but _10x_ and _rockstar dev_ lingo gives me headaches 😆.
...
Can anyone tell me why tech articles all start with a seemingly irrelevant image 🙃?

- 👉 I'll keep working on my [website](https://maferland.com).
- 👉 I'll try to give a little doc to my latest (and first?) [library](https://github.com/maferland/hooks)... Releasing doc-less code is bad. Not releasing anything is worse!
- 👉 And I will keep learning with [EpicReact.dev](epicreact.dev)

## Keep reading 👇

Another nice article on the topic [Learn in public hack](https://www.swyx.io/learn-in-public-hack/) by [SWYX](https://twitter.com/swyx/)
