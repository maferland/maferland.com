...
👉 I'll keep working on my [website](https://maferland.com). <br>
👉 I'll try to give a little doc to my latest (and first?) [library](https://github.com/maferland/hooks)... Releasing doc-less code is bad. Not releasing anything is worse!<br>
👉 And I will keep learning with [EpicReact.dev](epicreact.dev) <br>
